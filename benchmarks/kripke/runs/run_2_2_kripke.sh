...
problem_name="kripke"
problem_desc=""
tracefilepath="/g/g92/marathe1/traces/kripke_traces/${nranks}"
whitelistpath="/g/g92/marathe1/libmsr/msr-safe/whitelists"

srun_options="--cpu_bind=rank --ntasks-per-socket=${nranks_per_socket} --sockets-per-node=1"
...
dramlim=0
inputdata=" --groups 64 --zones 16,16,16 --procs 2,1,1 --niter 20 " 
                    ...
                    do
                        ...
                        do
                            ...
                            then
                                ...
                                KMP_AFFINITY=compact PROCESS_PER_SAMPLER=1 \
