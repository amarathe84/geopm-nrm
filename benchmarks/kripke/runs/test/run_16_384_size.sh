...
dramlim=0
inputdata=" --groups 16 --zones 92,92,92 --procs 8,8,6 --niter 20 " 
...
####                           do
                            ...
                            then
                                ...
                                local_input=" --nest ${nestiter} --layout ${layoutiter} --dset ${dsetiter} --gset ${gsetiter} --zset 4,4,4 --pmethod ${methoditer}"
