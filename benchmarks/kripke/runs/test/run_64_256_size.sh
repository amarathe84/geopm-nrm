...
dramlim=0
inputdata=" --groups 128 --zones 128,128,128 --quad 128 --procs 4,8,8 --niter 2 " 
...
####                           do
                            nestiter="ZGD"
                            layoutiter=0
                            dsetiter=8    # Has to be multiple of 8 and --quad has to be a multiple of this
                            gsetiter=2    # has to  be a factor of --groups
                            methoditer="sweep"
                            pkglim=50
                            ompiter=6
...
####                               then
                                ...
                                KMP_AFFINITY=compact PROCESS_PER_SAMPLER=4 \
