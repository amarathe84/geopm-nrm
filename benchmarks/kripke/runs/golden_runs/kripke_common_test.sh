...
common_inputdata=" --groups 64 --zones 192,144,96 --quad 64 --legendre 0"
#common_inputdata=" --groups 128 --zones 256,256,128 --quad 8 --legendre 0"
#common_inputdata=" --groups 16 --zones 256,256,128 --quad 16 --legendre 1"

source run_${nnodes}_${nranks}_common.sh
tracefilepath="/g/g92/marathe1/traces/kripke_traces/test_golden_runs/${nnodes}/${nranks}"
inputdata=`echo "${common_inputdata} ${rank_input} --niter 20"`
...
for pkglim in 60 100; #`seq 95 -5 55`;
do
...
#        echo "Nesting1=${nestiter}"
        ...
        do
            ...
            do
                for gsetiter in 8; #1 2 4 8 16 32 64;
                do
...
#                                    echo "${local_input} $curr_trace"
                                    ...
                                    (OMP_PROC_BIND=true \
                                     ...
                                     PROCESS_PER_SAMPLER=${process_per_sampler} \
